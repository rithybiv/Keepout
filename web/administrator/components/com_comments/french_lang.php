...
//comments.php
$_COM_C_COM_NUMBER = "Nombre de commentaires";
$_COM_C_NO_COM     = "Il n'existe pas encore de commentaire. N'hésitez pas à en ajouter un (en utilisant le formulaire ci-dessous)....";
$_COM_C_POST       = "Envoyé par";
$_COM_C_HOMEPAGE   = "dont la page web est la suivante";
$_COM_C_DATE_ON    = "le";
$_COM_C_DATE_AT    = "à";
$_COM_C_ADD_COM    = "Ajoutez vos commentaires à cet article...";
$_COM_C_NAME       = "Nom <small><i>(information nécessaire)</i></small>";
$_COM_C_EMAIL      = "Adresse e-mail <small><i>(information nécessaire)</i></small>";
$_COM_C_EMAIL_NOT  = "Votre adresse e-mail n'apparaîtra pas sur le site et ne sera visible que pour l'administrateur.";
$_COM_C_HOMEPAGE_IN= "Page d'accueil";
$_COM_C_COM        = "Commentaire";
$_COM_C_FULLY      = "Veuillez compléter entièrement le formulaire!";
$_COM_C_NEW_COM    = "Nouveau commentaire sur";
$_COM_C_HAVE_NEW   = "Un nouveau commentaire existe sur l'article suivant:";
$_COM_C_LOGIN      = "Veuillez vous connecter et publier ou éliminer ce commentaire";
$_COM_C_QUICKLINK  = "Voici un lien rapide vers la zone de connection";
$_COM_C_THANKS     = "Merci de votre commentaire au sujet de";
$_COM_C_THANKS2    = "Merci de votre commentaire au sujet de l'article suivant";
$_COM_C_ADMIN_REV  = "Un administrateur va prendre en compte votre commentaire rapidement";
$_COM_C_ENTERED    = "Vous venez d'entrer dans";
$_COM_C_VISIT      = "Visitez de nouveau notre site très bientôt à";
$_COM_C_THANKS3    = "Merci de vos commentaires. Ils ont été ajoutés à cette page.";
$_COM_C_THANKS4    = "Merci de vos commentaires. Ils seront revus par un chercheur avant d'être publiés.";
$_COM_C_SUBMIT     = "Soumettre";
$_COM_C_RESET     = "Remise à jour";
$_COM_C_NOT_AUTH   = "Vous n'êtes apparemment pas autorisés à transmettre un commentaire. Veuillez vous connecter.";
?>
