	...
	function poll_vote_form_html( &$poll, &$options, $Itemid ) {
		...
		?>
			...
			<tr>
			  ...
			  <input type="button" name="option" class="button" value="RESULTS"<?php //echo _BUTTON_RESULTS; ?> onclick="document.location.href='<?php echo sefRelToAbs("index.php?option=com_poll&amp;task=results&amp;id=$poll->id"); ?>';" />
			  </td>
			</tr>
		</table>
